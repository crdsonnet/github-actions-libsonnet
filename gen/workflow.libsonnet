{
  ...
  concurrency+:
    {
      ...
      concurrency+:
        {
          '#withCancelInProgress': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: 'To cancel any currently running job or workflow in the same concurrency group, specify cancel-in-progress: true.' } },
          withCancelInProgress(value): { concurrency+: { 'cancel-in-progress': value } },
          '#withCancelInProgressMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: 'To cancel any currently running job or workflow in the same concurrency group, specify cancel-in-progress: true.' } },
  ...
  defaults+:
    {
      ...
      run+:
        {
          '#withShell': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: "You can override the default shell settings in the runner's operating system using the shell keyword. You can use built-in shell keywords, or you can define a custom set of shell options." } },
          withShell(value): { defaults+: { run+: { shell: value } } },
          '#withShellMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: "You can override the default shell settings in the runner's operating system using the shell keyword. You can use built-in shell keywords, or you can define a custom set of shell options." } },
  ...
  '#withEnv': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'To set custom environment variables, you need to specify the variables in the workflow file. You can define environment variables for a step, job, or entire workflow using the jobs.<job_id>.steps[*].env, jobs.<job_id>.env, and env keywords. For more information, see https://docs.github.com/en/actions/learn-github-actions/workflow-syntax-for-github-actions#jobsjob_idstepsenv' } },
  withEnv(value): { env: value },
  '#withEnvMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'To set custom environment variables, you need to specify the variables in the workflow file. You can define environment variables for a step, job, or entire workflow using the jobs.<job_id>.steps[*].env, jobs.<job_id>.env, and env keywords. For more information, see https://docs.github.com/en/actions/learn-github-actions/workflow-syntax-for-github-actions#jobsjob_idstepsenv' } },
  ...
  '#withOn': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The name of the GitHub event that triggers the workflow. You can provide a single event string, array of events, array of event types, or an event configuration map that schedules a workflow or restricts the execution of a workflow to specific files, tags, or branch changes. For a list of available events, see https://help.github.com/en/github/automating-your-workflow-with-github-actions/events-that-trigger-workflows.' } },
  withOn(value): { on: value },
  '#withOnMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The name of the GitHub event that triggers the workflow. You can provide a single event string, array of events, array of event types, or an event configuration map that schedules a workflow or restricts the execution of a workflow to specific files, tags, or branch changes. For a list of available events, see https://help.github.com/en/github/automating-your-workflow-with-github-actions/events-that-trigger-workflows.' } },
  ...
  on+:
    {
      ...
      '#withBranchProtectionRule': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withBranchProtectionRule(value): { on+: { branch_protection_rule: value } },
      '#withBranchProtectionRuleMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withBranchProtectionRuleMixin(value): { on+: { branch_protection_rule+: value } },
      '#withCheckRun': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withCheckRun(value): { on+: { check_run: value } },
      '#withCheckRunMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withCheckRunMixin(value): { on+: { check_run+: value } },
      '#withCheckSuite': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withCheckSuite(value): { on+: { check_suite: value } },
      '#withCheckSuiteMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withCheckSuiteMixin(value): { on+: { check_suite+: value } },
      '#withCreate': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withCreate(value): { on+: { create: value } },
      '#withCreateMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      ...
      '#withDeployment': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDeployment(value): { on+: { deployment: value } },
      '#withDeploymentMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDeploymentMixin(value): { on+: { deployment+: value } },
      '#withDeploymentStatus': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDeploymentStatus(value): { on+: { deployment_status: value } },
      '#withDeploymentStatusMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDeploymentStatusMixin(value): { on+: { deployment_status+: value } },
      '#withDiscussion': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDiscussion(value): { on+: { discussion: value } },
      '#withDiscussionMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDiscussionMixin(value): { on+: { discussion+: value } },
      '#withDiscussionComment': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDiscussionComment(value): { on+: { discussion_comment: value } },
      '#withDiscussionCommentMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withDiscussionCommentMixin(value): { on+: { discussion_comment+: value } },
      '#withFork': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withFork(value): { on+: { fork: value } },
      '#withForkMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withForkMixin(value): { on+: { fork+: value } },
      '#withGollum': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withGollum(value): { on+: { gollum: value } },
      '#withGollumMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withGollumMixin(value): { on+: { gollum+: value } },
      '#withIssueComment': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withIssueComment(value): { on+: { issue_comment: value } },
      '#withIssueCommentMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withIssueCommentMixin(value): { on+: { issue_comment+: value } },
      '#withIssues': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withIssues(value): { on+: { issues: value } },
      '#withIssuesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withIssuesMixin(value): { on+: { issues+: value } },
      '#withLabel': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withLabel(value): { on+: { label: value } },
      '#withLabelMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withLabelMixin(value): { on+: { label+: value } },
      '#withMember': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMember(value): { on+: { member: value } },
      '#withMemberMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMemberMixin(value): { on+: { member+: value } },
      '#withMergeGroup': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMergeGroup(value): { on+: { merge_group: value } },
      '#withMergeGroupMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMergeGroupMixin(value): { on+: { merge_group+: value } },
      '#withMilestone': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMilestone(value): { on+: { milestone: value } },
      '#withMilestoneMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withMilestoneMixin(value): { on+: { milestone+: value } },
      '#withPageBuild': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPageBuild(value): { on+: { page_build: value } },
      '#withPageBuildMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPageBuildMixin(value): { on+: { page_build+: value } },
      '#withProject': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProject(value): { on+: { project: value } },
      '#withProjectMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProjectMixin(value): { on+: { project+: value } },
      '#withProjectCard': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProjectCard(value): { on+: { project_card: value } },
      '#withProjectCardMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProjectCardMixin(value): { on+: { project_card+: value } },
      '#withProjectColumn': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProjectColumn(value): { on+: { project_column: value } },
      '#withProjectColumnMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withProjectColumnMixin(value): { on+: { project_column+: value } },
      '#withPublic': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPublic(value): { on+: { public: value } },
      '#withPublicMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPublicMixin(value): { on+: { public+: value } },
      '#withPullRequest': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequest(value): { on+: { pull_request: value } },
      '#withPullRequestMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestMixin(value): { on+: { pull_request+: value } },
      '#withPullRequestReview': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestReview(value): { on+: { pull_request_review: value } },
      '#withPullRequestReviewMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestReviewMixin(value): { on+: { pull_request_review+: value } },
      '#withPullRequestReviewComment': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestReviewComment(value): { on+: { pull_request_review_comment: value } },
      '#withPullRequestReviewCommentMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestReviewCommentMixin(value): { on+: { pull_request_review_comment+: value } },
      '#withPullRequestTarget': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestTarget(value): { on+: { pull_request_target: value } },
      '#withPullRequestTargetMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPullRequestTargetMixin(value): { on+: { pull_request_target+: value } },
      '#withPush': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPush(value): { on+: { push: value } },
      '#withPushMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withPushMixin(value): { on+: { push+: value } },
      '#withRegistryPackage': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withRegistryPackage(value): { on+: { registry_package: value } },
      '#withRegistryPackageMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withRegistryPackageMixin(value): { on+: { registry_package+: value } },
      '#withRelease': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withRelease(value): { on+: { release: value } },
      '#withReleaseMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withReleaseMixin(value): { on+: { release+: value } },
      '#withRepositoryDispatch': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withRepositoryDispatch(value): { on+: { repository_dispatch: value } },
      '#withRepositoryDispatchMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      ...
      '#withStatus': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withStatus(value): { on+: { status: value } },
      '#withStatusMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withStatusMixin(value): { on+: { status+: value } },
      '#withWatch': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withWatch(value): { on+: { watch: value } },
      '#withWatchMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      ...
      '#withWorkflowRun': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withWorkflowRun(value): { on+: { workflow_run: value } },
      '#withWorkflowRunMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: '' } },
      withWorkflowRunMixin(value): { on+: { workflow_run+: value } },
    },
  '#withPermissions': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'You can modify the default permissions granted to the GITHUB_TOKEN, adding or removing access as required, so that you only allow the minimum required access.' } },
  withPermissions(value): { permissions: value },
  '#withPermissionsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'You can modify the default permissions granted to the GITHUB_TOKEN, adding or removing access as required, so that you only allow the minimum required access.' } },
